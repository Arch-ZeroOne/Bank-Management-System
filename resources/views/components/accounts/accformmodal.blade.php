...
<div class="flex flex-col items-center  shadow-xl w-[40%] rounded-xl top-[140px]  gap-4 p-4 h-md ml-auto mr-auto bg-white text-black relative " id="animated-addform">
    <x-exit/>
