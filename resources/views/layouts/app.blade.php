...
<body>
    ...
    <div class="min-h-screen" style="display:flex; ">
        ...
        <!-- Page Content -->
        <div class="w-full">
            <header class="bg-blue-400 shado    w-xl p-2 w-full  items-center" style="height: 50px">
                <!-- Settings Dropdown -->
                <div class="hidden sm:flex sm:items-center sm:ms-6  " style="justify-content: end;margin-right:70px;">
