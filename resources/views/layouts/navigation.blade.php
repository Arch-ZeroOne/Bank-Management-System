<nav x-data="{ open: false }" class="bg-blue-400 shadow-xl   border-b border-gray-100 dark:border-gray-700 "
    style="width:20%">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-5">
        <div class="flex justify-between h-16 flex-col items-center ">
            <div class="flex flex-col item-center justify-center gap-5  ">
                <!-- Logo -->
